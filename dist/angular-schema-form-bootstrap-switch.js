...
angular.module("schemaForm").run(["$templateCache", function($templateCache) {$templateCache.put("directives/decorators/bootstrap/switch/switch.html","<div class=\"form-group schema-form-checkbox {{form.htmlClass}}\" ng-class=\"{\\\'has-error\\\': form.disableErrorState !== true && hasError(), \\\'has-success\\\': form.disableSuccessState !== true && hasSuccess()}\">\r\n   <label class=\"control-label {{form.labelHtmlClass}}\" ng-show=\"showTitle()\">{{ form.title }}</label>\r\n   <input bs-switch data-indeterminate=\"false\" type=\"checkbox\" sf-changed=\"form\" ng-disabled=\"form.readonly\" sf-changed=\"form\" schema-validate=\"form\" ng-model=\"$$value$$\"\r\n          ng-model-options=\"form.ngModelOptions\" schema-validate=\"form\" class=\"{{form.fieldHtmlClass}}\"\r\n          name=\"{{form.key.slice(-1)[0]}}\"></label>\r\n   <div class=\"help-block\" sf-message=\"form.description\"></div>\r\n</div>");}]);
(function(root, factory) {
    if (typeof define === 'function' && define.amd) {
        define(['angular-schema-form'], factory);
    } else if (typeof exports === 'object') {
...
return angularSchemaFormBootstrapSwitch;
}));
